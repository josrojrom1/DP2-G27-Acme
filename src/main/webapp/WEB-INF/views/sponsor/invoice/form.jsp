...
<acme:form>
	<acme:input-textbox code="sponsor.invoice.form.label.code" path="code" readonly="${readOnly}"/>
	<acme:input-moment code="sponsor.invoice.form.label.registration"
		path="registration" readonly="${readOnly}"/>
	...
	<acme:input-double code="sponsor.invoice.form.label.totalAmount"
	...
	<jstl:choose>
		...
		<jstl:when test="${_command == 'create'}">
			<acme:submit code="sponsor.invoice.form.button.create"
				action="/sponsor/invoice/create?masterId=${masterId}" />
		</jstl:when>
	</jstl:choose>
